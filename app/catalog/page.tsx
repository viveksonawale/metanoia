...
export default function CatalogPage() {
    return (
        <main className="min-h-screen bg-black text-white selection:bg-[#44d62c]/20 selection:text-[#44d62c]">
            ...
            {/* Header Section */}
            <section className="pt-32 pb-12 px-4 border-b border-[#222]">
                <div className="max-w-[1400px] mx-auto">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            <div className="text-[#666] text-xs font-bold tracking-widest uppercase mb-4">
                                Catalog
                            </div>
                        ...
                        <div className="md:pb-2">
                            ...
                            <Link href="/contact" className="hidden md:flex items-center text-sm font-bold text-[#999] hover:text-white transition-colors uppercase tracking-wider">
